 ...
 */
final class Version20250830230126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_client CHANGE code code LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE nnc_bill CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL, CHANGE bill_number bill_number INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_bill CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE bill_number bill_number INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE nnc_client CHANGE code code INT NOT NULL');
        $this->addSql('ALTER TABLE nnc_service CHANGE service_id service_id INT DEFAULT NULL, CHANGE dependency dependency INT DEFAULT NULL');
