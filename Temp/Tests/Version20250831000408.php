 ...
 */
final class Version20250831000408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_bill CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL, CHANGE bill_number bill_number VARCHAR(20) DEFAULT NULL, CHANGE purchase_order purchase_order VARCHAR(100) DEFAULT NULL, CHANGE full_bill_date full_bill_date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE nnc_client ADD siret LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_bill CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE bill_number bill_number VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE purchase_order purchase_order VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE full_bill_date full_bill_date DATETIME DEFAULT \'NULL\', CHANGE date date DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE nnc_client DROP siret');
        $this->addSql('ALTER TABLE nnc_service CHANGE service_id service_id INT DEFAULT NULL, CHANGE dependency dependency INT DEFAULT NULL');
