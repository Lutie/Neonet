 ...
 */
final class Version20250830225823 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_client ADD code INT NOT NULL');
        $this->addSql('ALTER TABLE nnc_bill ADD bill_number INT DEFAULT NULL, ADD purchase_order VARCHAR(100) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_bill DROP bill_number, DROP purchase_order, CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE nnc_client DROP code');
        $this->addSql('ALTER TABLE nnc_service CHANGE service_id service_id INT DEFAULT NULL, CHANGE dependency dependency INT DEFAULT NULL');
