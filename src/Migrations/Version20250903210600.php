 ...
 */
final class Version20250903210600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_bill ADD bill_number VARCHAR(20) DEFAULT NULL, ADD purchase_order VARCHAR(100) DEFAULT NULL, ADD full_bill_date DATETIME DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE nnc_client ADD code LONGTEXT DEFAULT NULL, ADD siret LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nnc_bill DROP bill_number, DROP purchase_order, DROP full_bill_date, CHANGE user_id user_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE nnc_client DROP code, DROP siret');
        $this->addSql('ALTER TABLE nnc_service CHANGE service_id service_id INT DEFAULT NULL, CHANGE dependency dependency INT DEFAULT NULL');
